...
/// <summary>购物车服务实现：维护行项集合并广播变更事件。</summary>
public sealed class CartService : ICartService
{
    ...
    public CartService(PosRepository repository, ISettingsService settings, IEventAggregator eventAggregator)
    {
    ...
    private void Publish() => _eventAggregator.GetEvent<CartChangedEvent>().Publish(Summary);
}
