...
using CommunityToolkitDemo.Common.Converters;
...
public sealed class ConvertersTests
{
    ...
    public void StatusLevelToBrush_MapsAllLevels()
    {
        ...
        Assert.IsType<SolidColorBrush>(converter.Convert(
            StatusNotificationMessage.StatusLevel.Success, typeof(Brush), null, Invariant));
        Assert.IsType<SolidColorBrush>(converter.Convert(
            StatusNotificationMessage.StatusLevel.Error, typeof(Brush), null, Invariant));
    }
}
