...
namespace CommunityToolkitDemo.Common.Converters;
...
public sealed class StatusLevelToBrushConverter : IValueConverter
{
    ...
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
        => value switch
        {
            StatusNotificationMessage.StatusLevel.Success => Success,
            StatusNotificationMessage.StatusLevel.Warning => Warning,
            StatusNotificationMessage.StatusLevel.Error => Error,
            _ => Info
        };
